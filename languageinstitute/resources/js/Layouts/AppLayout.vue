                    ...
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ms-auto">
                            <div class="ms-2 relative">
                                <input type="checkbox" name="light-switch" v-model="isDark"
                                    class="light-switch sr-only" />
                                <label @click="toggleDark()"
                                    ...
                                    for="light-switch">
                                    <svg class="w-4 h-4 dark:hidden" width="16" height="16"
                                    ...
                                    <svg class="w-4 h-4 hidden dark:block" width="16" height="16"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path class="fill-current text-slate-400"
